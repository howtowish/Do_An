...
<br><div class="row">
 <div class="col-sm-4" style="background-color:#e74c3c;margin-left: 1%;border-radius: 20px;color:#ecf0f1" >
  ...
  <div class="col-sm-7" style="color:#191970; width:58%" >
   <center><h2>LỊCH PHÂN CÔNG PHẢN BIỆN</h2></center>  
  <br><table class="table" >
    ...
    <div class="panel panel-default">
      <div class="panel-body" style="height:100px;text-align:center"><h2> PHÂN CÔNG PHẢN BIỆN<h2></div>
       <form>
    ...
    <div class="form-group">
      <label for="comment">Giảng viên phản biện:</label>
      <select class="form-control input-lg" id="sel2">
        <option>Đặng Thanh Dũng</option>
        <option>Lê Văn Vinh</option>
        <option>Từ Tuyết Hồng</option>
        <option>Mai Tuấn Khôi</option>
        <option>Đặng Thị Kim Giao</option>
        <option>Nguyễn Minh Đạo</option>
        <option>Trần Công Tú</option>
        <option>Nguyễn Phương</option>
        <option>Nguyễn Thanh Sơn</option>
        <option>Nguyễn Thi Văn</option>
       
      </select>
    </div>
     <div class="form-group">
      <label for="comment">Phòng:</label>
      <select class="form-control input-lg" id="sel2">
        <option>A4-401</option>
        <option>A4-402</option>
        <option>A4-403</option>
         <option>A4-303</option>
          <option>A4-302</option>
           <option>A4-301</option>
        <option>A5-201</option>
        <option>A5-202</option>
        <option>A5-203</option>
        <option>A5-302</option>
        <option>A5-301</option>
