...
<div class="header-lower" >
  ...
  <form action="/action_page.php">
	...
	<div id="new1" class="container lead">
		<h1 class="text-center">Trải nghiệm chương trình<br>“Một ngày là sinh viên Bách khoa”</h1>
	
      <br>
      <div class="embed-responsive embed-responsive-16by9">
  <iframe class="embed-responsive-item" src="../video/Sẵn sàng là sinh viên Bách Khoa Hà Nội.mp4" allowfullscreen></iframe>
</div>	
	</div>
